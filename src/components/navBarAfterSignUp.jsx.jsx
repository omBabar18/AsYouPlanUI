...
export const NavBarComponentAfterSignUp = () => {
    return (
        <div id="webcrumbs">
                ...
                <nav className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden lg:flex items-center space-x-8">
                        ...
                        <div className="flex items-center space-x-3 ml-6">
                            <details className="relative">
                                <summary className="flex items-center space-x-2 px-4 py-2 border border-white rounded-lg hover:bg-white hover:text-blue-600 transition-all duration-200 cursor-pointer list-none">
                                    <span className="material-symbols-outlined text-2xl">account_circle</span>
                                    <span className="hidden md:inline">Profile</span>
                                    <span className="material-symbols-outlined text-sm">expand_more</span>
                                </summary>
                                <div className="absolute right-0 mt-2 w-40 bg-white text-gray-800 rounded-lg shadow-xl z-50 py-2">
                                    <a href="#" className="flex items-center space-x-2 px-4 py-2 hover:bg-blue-50 transition-colors duration-200">
